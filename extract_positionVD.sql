-- Function: extract_positionvd(json, json)

-- DROP FUNCTION extract_positionvd(json, json);
...
END;$BODY$
  ...
  COST 100;
ALTER FUNCTION extract_positionvd(json, json)
  OWNER TO postgres;
COMMENT ON FUNCTION extract_positionvd(json, json) IS 'extract_positionVD';
